...
const EmployeeLogin = () => {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        if (res.data.success) {
            ...
            // Kiểm tra role nhân viên (E, M, A, S)
            const employeeRoles = ['E', 'M', 'A', 'S']; // Employee, Manager, Admin, Super Admin
            if (!employeeRoles.includes(role_id)) {
            ...
            <form onSubmit={handleLogin}>
                ...
                <div className="text-center mb-3">
                    <small className="text-muted">
                        * Chỉ dành cho nhân viên, quản lý và admin
                    </small>
                </div>
            </form>
        </>
