    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="info-box">
                <p style="font-size: 15px; color: #555; margin-bottom: 8px;">
                    <strong>📅 Ngày tạo:</strong> {{ $created_at ?? now()->format('d/m/Y H:i:s') }}
                </p>
                <p style="font-size: 15px; color: #555; margin-bottom: 8px;">
                    <strong>⏰ Thời gian hiệu lực:</strong> <span id="expiry-seconds">60</span> giây
                </p>
                <p style="font-size: 15px; color: #555;">
                    <strong>🎯 Mục đích:</strong> {{ $purpose ?? 'Đăng ký tài khoản mới' }}
                </p>
            </div>
        ...
        <div class="footer">
            <p style="font-size: 14px; color: #888; margin-bottom: 10px;">
                © {{ date('Y') }} {{ config('app.name', 'Your App Name') }}. All rights reserved.
            </p>
